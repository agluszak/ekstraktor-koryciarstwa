...
class FrameSlotGrounder:
    ...
    def ground_public_employment_role(
        ...
        *,
        ...
        if role_cluster is not None and not self._is_public_office_role(
            context,
        ...
        if candidate is None:
            return None
        if self._invalid_role_candidate(document, context, clause, candidate):
            return None
        return GroundedRoleLabel(
    ...
    def _cluster_normalized_name(
        ...
        if entities_by_id is None:
            entities_by_id = cls._entities_by_id(document)
        return read_normalized_name_for_cluster(cluster, entities_by_id)
    ...
    @staticmethod
    def _compact_alias_match_score(
        document: ArticleDocument,
        alias: str,
        cluster: EntityCluster,
        entities_by_id: dict[EntityID, Entity] | None = None,
