...
class StanzaPolishMorphologyAnalyzer:
    """Stanza-backed Polish morphology analyzer using the shared pipeline runtime."""
    ...
    def analyze(self, text: str) -> MorphologicalAnalysis:
        ...
        is_nominative = all(
            wa.case == "Nom" for wa in word_analyses if wa.pos in {"NOUN", "PROPN", "ADJ", "DET"}
        )
