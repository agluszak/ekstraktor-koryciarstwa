...
SOCIAL_RELATION_DETAILS: Final[dict[str, RelationshipDetail]] = {
    "kolega": RelationshipDetail.ASSOCIATE,
    "koleżanka": RelationshipDetail.ASSOCIATE,
    "znajomy": RelationshipDetail.ASSOCIATE,
    "znajoma": RelationshipDetail.ASSOCIATE,
    "towarzysz": RelationshipDetail.ASSOCIATE,
    "towarzyszka": RelationshipDetail.ASSOCIATE,
    "przyjaciel": RelationshipDetail.ASSOCIATE,
    "przyjaciółka": RelationshipDetail.ASSOCIATE,
    "druh": RelationshipDetail.ASSOCIATE,
    "druhna": RelationshipDetail.ASSOCIATE,
    "kompan": RelationshipDetail.ASSOCIATE,
    "kompanka": RelationshipDetail.ASSOCIATE,
    "kamrat": RelationshipDetail.ASSOCIATE,
    "kamratka": RelationshipDetail.ASSOCIATE,
    "partner": RelationshipDetail.ASSOCIATE,
    "partnerka": RelationshipDetail.ASSOCIATE,
    "współwłaściciel": RelationshipDetail.ASSOCIATE,
    "współwłaścicielka": RelationshipDetail.ASSOCIATE,
    "współuczestnik": RelationshipDetail.ASSOCIATE,
    "współuczestniczka": RelationshipDetail.ASSOCIATE,
    "udziałowiec": RelationshipDetail.ASSOCIATE,
    "udziałowczyni": RelationshipDetail.ASSOCIATE,
    ...
    "kumpel": RelationshipDetail.ASSOCIATE,
    "kumpela": RelationshipDetail.ASSOCIATE,
}
