    ...
    _patterns = tuple(
        sorted(
            (
                ...
                RolePattern(("prezes",)),
                RolePattern(("przewodnicząca",)),
                RolePattern(("przewodniczący",)),
                RolePattern(("zarząd",)),
                RolePattern(("dyrektor",)),
                RolePattern(("szef",)),
                RolePattern(("szefowa",)),
                RolePattern(("wiceszef",)),
                RolePattern(("doradca",)),
                ...
                RolePattern(("radna",)),
                RolePattern(("poseł",)),
                RolePattern(("posłanka",)),
                RolePattern(("senator",)),
                RolePattern(("minister",)),
                RolePattern(("wójt",)),
                RolePattern(("starosta",)),
                RolePattern(("wojewoda",)),
                RolePattern(("marszałek",)),
            ),
